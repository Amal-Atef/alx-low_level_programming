...
/**
 * check_elf - Checks IS a file is an ELF file.
...
/**
 * print_entry - Print the point of an ELF header.
...
/**
 * main - Displays the information exist in the
 * ELF header at the start of an ELF file.
 * @argc: number of arguments supply to the program.
